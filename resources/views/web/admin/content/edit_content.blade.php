...
<div class="container mx-auto mt-8">
    <h1 class="text-2xl font-bold text-gray-700 mb-6">Edit Konten</h1>
    ...
    <form action="{{ route('content.update', $content->id_content) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
            ...
            <label class="block text-sm">
                ...
                >
                    ...
                    @foreach ($course as $course)
                        <option value="{{ $course->id_course }}" {{ $content->id_course == $course->id_course ? 'selected' : '' }}>
                            {{ $course->name_course }}
                        </option>
                    @endforeach
                </select>
            ...
            <label class="block mt-4 text-sm">
                ...
                <input
                    ...
                    name="name_content"
                    id="name_content"
                    value="{{ old('name_content', $content->name_content) }}"
                    class="block w-full mt-1 text-sm border-gray-300 rounded-lg focus:border-purple-400 focus:outline-none focus:ring-purple-400"
