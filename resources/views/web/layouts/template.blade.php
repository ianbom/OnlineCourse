      ...
      >
        <div class="py-4 text-gray-500">
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
                <!-- Highlight Bar -->
                @if(Request::is('admin/index/user'))
                <span
                    class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                    aria-hidden="true"
                ></span>
                ...
                <a
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800
                    {{ Request::is('admin/index/user') ? 'text-gray-800' : '' }}"
            ...
            <li class="relative px-6 py-3">
                <!-- Highlight Bar -->
                @if(Request::is('admin/index/bundle'))
                <span
                    class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                    aria-hidden="true"
                ></span>
                ...
                <a
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800
                    {{ Request::is('admin/index/bundle') ? 'text-gray-800' : '' }}"
                ...
                >
                    ...
                    <span class="ml-4">Bundle</span>
                </a>
            </li>

            <li class="relative px-6 py-3">
                <!-- Highlight Bar -->
                @if(Request::is('admin/index/course') || Request::is('admin/course/create') || Request::is('admin/course/{id}/edit'))
                <span
                    class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                    aria-hidden="true"
                ></span>
                ...
                <a
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800
                    {{ Request::is('admin/index/course') ? 'text-gray-800' : '' }}"
            ...
            <li class="relative px-6 py-3">
                ...
                <a
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800
                    {{ Request::is('admin/index/content') ? 'text-gray-800' : '' }}"
            ...
            <li class="relative px-6 py-3">
                <!-- Highlight Bar -->
                @if(Request::is('admin/index/materi'))
                <span
                    class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                    aria-hidden="true"
                ></span>
                ...
                <a
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800
                    {{ Request::is('admin/index/materi') ? 'text-gray-800' : '' }}"
            ...
            <li class="relative px-6 py-3">
                <!-- Highlight Bar -->
                @if(Request::is('admin/index/category'))
                <span
                    class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                    aria-hidden="true"
                ></span>
                ...
                <a
                    class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800
                    {{ Request::is('admin/index/category') ? 'text-gray-800' : '' }}"
            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="./login.html">Content</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800"
                  >
