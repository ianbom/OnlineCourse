...
<div class="container mx-auto p-16">
    ...
    <div class="mb-10">
        <div class="relative max-w-xl">
            ...
            <!-- Cari button -->
            <button class="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[#F58A44] text-white px-6 py-1.5 rounded-[12px] text-[14px] font-semibold focus:outline-none focus:ring-2 focus:ring-[#F58A44]">
                Cari
            </button>
        </div>
    </div>
    ...
    <div class="mb-10">
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 gap-8">
           @include('web.user.components.list_catatan', ['course' => $course])
        </div>
    </div>
</div>
