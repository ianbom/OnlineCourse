    ...
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2  md:text-left">
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-semibold text-[#1A1A1A] mb-6" style="font-family: 'Libre Baskerville', serif; line-height: 1.2;">
                    Menjadi
                    <span class="text-[#F58A44] font-light italic"> Pemuda Berkualitas Unggulan </span>yang Dinanti-nantikan
                </h1>
                <p class="text-[#484848] text-lg mb-12">
                    Platform belajar online terdepan di Indoneisa yang membahas ilmu kehidupan berbagai tahapan bagi pemuda dengan beragam pendekatan keilmuan sesuai nilai-nilai islam.                </p>
                   <a href="#" class="bg-[#F58A44] text-white px-6 py-3 rounded-[16px] font-semibold hover:bg-[#6F2E03] hover:text-[#F58A44] transition duration-300 focus:outline-none">
    JELAJAHI
</a>
            ...
            <div class="md:w-1/2 mt-8 md:mt-0 p-10">
                <img src="{{ asset('img/sec1.png') }}" alt="Hero Image" class="mx-auto md:ml-auto max-w-full rounded-lg p-10">
            </div>
        </div>
    </div>
</section>
     ...
     <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div class="bg-[#F0F0F0] rounded-[16px] p-6">
                ...
                <p class="text-[#484848] mb-4">Dipandu oleh pemateri yang siap kasih ilmu dengan cara yang ringan, fun, dan mudah dipahami.  Mulai dari ustadz, ustadzah, psikolog, dokter, dan lainnya.</p>
            </div>
            <div class="bg-[#F0F0F0] rounded-[16px] p-6">
                <h5 class="font-semibold text-lg text-[#350A0AFF]">Video Pembelajaran yang Ringkas & Aplikatif</h5>
                <p class="text-[#484848] mb-4">Nggak cuma teori, kamu akan dapat contoh-contoh kasus sehari-hari yang bikin kamu bilang, “Oh, gini toh ternyata!”         </p>
            </div>
            <div class="bg-[#F0F0F0] rounded-[16px] p-6">
                <h5 class="font-semibold text-lg text-[#484848]">Materi dijelaskan dalam bentuk video-video ringkas dan tersedia modul ppt</h5>
                <p class="text-[#484848] mb-4">Materi dijelaskan dalam bentuk video-video ringkas dan tersedia modul ppt</p>
            </div>
            ...
            <div class="bg-[#DBF5D2] rounded-[16px] p-6">
                ...
                <p class="text-[#484848] mb-4">Biaya terjangkau untuk semua kalangan baik untuk pelajar, mahasiswa, ibu rumah tangga, atau pekerja.</p>
            </div>
            <div class="bg-[#F0F0F0] rounded-[16px] p-6">
                <h5 class="font-semibold text-lg text-[#484848]">Waktu Belajar Fleksibel</h5>
                <p class="text-[#484848] mb-4">Tanpa perlu khawatir menganggu kesibukan! Video materi bisa diakses kapan saja dan dimana saja.
                </p>
            </div>
            <div class="bg-[#FDE4D3] rounded-[16px] p-6">
                <h5 class="font-semibold text-lg text-[#484848]">Live Session</h5>
                <p class="text-[#484848] mb-4">Peserta mendapatkan akses gratis tanpa syarat untuk mengikuti sesi LIVE melalui program SHAETALK dengan berbagai topik yang beragam.

                </p>
            </div>
            <div class="bg-[#DBF5D2] rounded-[16px] p-6">
                <h5 class="font-semibold text-lg text-[#484848]">Quiz dan E-Sertifikat                </h5>
                <p class="text-[#484848] mb-4">Terdapat quiz di setiap pembahasan untuk mengukur pemahaman peserta.  Dilengkapi E-Sertifikat untuk peserta yang sudah selesai menyimak materi.</p>
            </div>
            <div class="bg-[#F0F0F0] rounded-[16px] p-6">
                <h5 class="font-semibold text-lg text-[#484848]">Grup Diskusi</h5>
                <p class="text-[#484848] mb-4">Disediakan grup dua arah untuk memudahkan komunikasi dan diskusi antar peserta yang bersifat opsional
...
<section id="cocok-bagi-kamu" class="py-32">
    <div class="container mx-auto">
        <h2 class="text-3xl sm:text-3xl md:text-3xl font-semibold text-[#1A1A1A] mb-8" style="font-family: 'Libre Baskerville', serif; line-height: 1.2;">
        ...
        </h2>        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <div class="flex flex-col items-center">
                <!-- Gambar -->
                <div class="bg-[#FDE4D3] rounded-[16px] mb-4">
                    <img src="{{ asset('img/cocok1.png') }}" alt="Image" class="w-full h-auto object-cover rounded-[16px]">
                </div>
                <!-- Card -->
                <div class="bg-[#FDE4D3] p-6 rounded-[16px]">
                    <p class="text-[#484848]">Jika kamu ingin belajar dengan cara yang lebih aplikatif dan fleksibel.</p>
                </div>
            </div>
            <div class="flex flex-col items-center">
                <!-- Gambar -->
                <div class="bg-[#FDE4D3] rounded-[16px] mb-4">
                    <img src="{{ asset('img/cocok2.png') }}" alt="Image" class="w-full h-auto object-cover rounded-[16px]">
                </div>
                <!-- Card -->
                <div class="bg-[#FDE4D3] p-6 rounded-[16px]">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="bg-[#DBF5D2] rounded-[16px] mb-4">
                    <img src="{{ asset('img/cocok3.png') }}" alt="Image" class="w-full h-auto object-cover rounded-[16px]">
                </div>
                <!-- Card -->
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="bg-[#F0F0F0] rounded-[16px] mb-4">
                    <img src="{{ asset('img/cocok4.png') }}" alt="Image" class="w-full h-auto object-cover rounded-[16px]">
                </div>
                <!-- Card -->
...
<section id="testimoni" class="bg-[#F58A44] py-32">
    <div class="container mx-auto">
        <h2 class="text-3xl sm:text-3xl md:text-3xl font-semibold text-white mb-6" style="font-family: 'Libre Baskerville', serif; line-height: 1.2;">
        ...
        <div class="flex flex-wrap justify-start space-y-6 sm:space-y-0 sm:space-x-6" id="testimonial-carousel">
            <div class="bg-[#FDE4D3] rounded-[16px] p-10 w-full sm:w-[calc(50%-1.5rem)]">
                <p class="text-[#484848] mb-4 text-left">"Alhamdulillah sangat bersyukur Allah izinkan belajar di program sebagus & sekeren Belajar Islam dan Pengembangan diri. Di Belajar Islam, materi well-structured, fasilitas lengkap, dan ada record nilai jadi kita bisa track perkembangan belajar. Di Pengembangan diri, para pemateri impressively insightful dan materinya incredibly dagiing banget bi idznillah! The self-development materials are quite advanced++sesuai dg Islamic values. It's such a valuable experience to learn here. Can't wait to join the new program held by SHAE again!"</p>

                <div class="flex items-center">
                    <!-- Circle image with border F58A44 -->
                    <img src="{{ asset('img/testimoni (1).png') }}" alt="User" class="p-1 w-16 h-16 rounded-full border-2 border-[#F58A44]">
            ...
            <div class="bg-white rounded-[16px] p-10 w-full sm:w-[calc(50%-1.5rem)]">
                <p class="text-[#484848] mb-4 text-left">"Alhamdulillah, banyak belajar di program2nya SHAE^^ learning platformnya membantu banget buat mereview materi & mengakes ulang kalo pas jam kelas sinyalnya buruk, quiz2nya juga MasyaAllah sangat menyokong pemahaman di kelas, adanya tugas studi kasus juga membuat peserta saling berdiskusi dalam menjawab masalah yg relate dengan pelajaran yg sudah diberikan. Akses untuk bertanya langsung dengan guru baik dikelas maupun di SBUM.. Jazakumullahu khairan SHAE semoga semakin berkembang dan memberi manfaat yang long last.. aamiin"</p>

                <div class="flex items-center">
                    <!-- Circle image with border F58A44 -->
                    <img src="{{ asset('img/testimoni (2).png') }}" alt="User" class="p-1 w-16 h-16 rounded-full border-2 border-[#F58A44]">
    ...
    <div class="container mx-auto flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 p-6 flex items-center justify-center">
            <div >
                ...
                <div class="bg-[#FDE4D3] rounded-[16px] p-6">
                    <p class="text-[#484848]">
                        Untuk mendapatkan akses LIVE SESSION, silakan join grup peserta SHAE Life! Link grup akan diberikan langsung setelah peserta berhasil mendaftar
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="w-full md:w-1/2 p-6">
            <div class="space-y-6">
                ...
                <div class="flex items-center">
                    <div class="p-6 w-12 h-12 bg-[#F58A44] text-white text-3xl flex justify-center items-center rounded-full"  style="font-family: 'Libre Baskerville', serif; line-height: 1.2;">
                        1
                    </div>
                    <div class="ml-4">
                        <p class="font-bold text-[#484848]">Berlangganan</p>
                        <p class="text-[#484848]">Klik LOGIN dan masukkan email pada portal pelanggan, pastikan kamu sudah membeli kelasnya. Jika belum, Klik MULAI BELAJAR di halaman ini.</p>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-[#484848]">Simak video materi dan Modul PPT yang sudah disediakan dalam platform untuk memahami topik pembelajaran lebih dalam.</p>
                    </div>
                </div>
                <hr class="border-2 border-[#F58A44] mt-2">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-[#484848]">Mengerjakan Quiz untuk mengukur pemahamanmu tentang materi yang telah dipelajari. Setiap quiz didesain untuk memberikan tantangan yang bermanfaat.</p>
                    </div>
                </div>
                <hr class="border-2 border-[#F58A44] mt-2">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-[#484848]">Klaim sertifikat setelah menyelesaikan pembelajaran. Sertifikat ini dapat menjadi bukti pengakuan atas keterampilan yang telah dipelajari.</p>
                    </div>
                </div>
...
<section id="materi" class=" pt-10 pb-20">
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 justify-center items-center">
            ...
            <div
            class="bg-[#F0F0F0] text-[#484848] rounded-[16px] p-6 text-center hover:bg-[#FDE4D3]"
...
<section id="about" class="pt-32">
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 mb-8 mr-20 md:mb-0 bg-[#F58A44] rounded-tl-[0px] rounded-tr-[50px] rounded-br-[50px] rounded-bl-[50px]">
                <img src="{{ asset('img/sec3.png') }}"  alt="About Image" class="max-w-full">
            </div>
            <div class="md:w-1/2">
                <h2 class="text-3xl sm:text-3xl md:text-3xl font-semibold text-[#1A1A1A] mb-6" style="font-family: 'Libre Baskerville', serif; line-height: 1.2;">
                    E-Learning
                ...
                <p class="text-[#484848] text-lg mb-12">
                    ...
                    <a href="#" class="bg-[#F58A44] text-white px-6 py-3 rounded-[16px] font-semibold hover:bg-[#6F2E03] hover:text-[#F58A44] transition duration-300">
MULAI BELAJAR                </a>
...
<div id="subscription" class="pt-32 pb-8 flex justify-center items-center min-h-screen bg-white">
    <section class="features max-w-6xl mx-auto">
        ...
        <!-- Deskripsi -->
        <p class="text-center text-[#1A1A1A] text-4xl font-semibold mb-12" style="font-family: 'Libre Baskerville', serif;">
    ...
    <section id="FAQ" class=" pt-24 pb-24">
        <div class="container mx-auto">
        <h2 class="text-3xl font-semibold text-center mb-12 text-[#1A1A1A]" style="font-family: 'Libre Baskerville', serif;">FAQ</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- FAQ 1 -->
            <div class="bg-[#FDE4D3] p-6 rounded-lg" id="faq-1">
                <div class="flex justify-between items-center">
                    <h3 class="text-xl font-semibold text-[#F58A44]" style="font-family: 'Inter', sans-serif;">Apakah ada sertifikat setelah selesai kursus?
                    </h3>
                    <button class="text-[#F58A44]" onclick="toggleAnswer(1)">
                        <span id="toggle-icon-1">+</span>
                    </button>
                </div>
                <p id="answer-1" class="text-[#484848] hidden mt-4" style="font-family: 'Inter', sans-serif;"> Ya, ada! Setelah menyelesaikan semua materi dan kuis, kamu akan mendapatkan sertifikat sebagai bukti telah menyelesaikan materi.
            ...
            <div class="bg-[#FDE4D3] p-6 rounded-lg" id="faq-2">
                <div class="flex justify-between items-center">
                    <h3 class="text-xl font-semibold text-[#F58A44]" style="font-family: 'Inter', sans-serif;">Kapan Waktu Belajarnya?
                ...
                <p id="answer-2" class="text-[#484848] hidden mt-4" style="font-family: 'Inter', sans-serif;">Waktu belajar fleksibel kapan saja dan dimana saja
            ...
            <div class="bg-[#FDE4D3] p-6 rounded-lg" id="faq-3">
                <div class="flex justify-between items-center">
                    <h3 class="text-xl font-semibold text-[#F58A44]" style="font-family: 'Inter', sans-serif;">Bagaimana Cara Belajarnya?
                    </h3>
                    <button class="text-[#F58A44]" onclick="toggleAnswer(3)">
                        <span id="toggle-icon-3">+</span>
                    </button>
                </div>
                <p id="answer-3" class="text-[#484848] hidden mt-4" style="font-family: 'Inter', sans-serif;">Cukup dengan menyimak video secara mandiri. Lalu kerjakan quiz setelah menyimak video materi
            ...
            <div class="bg-[#FDE4D3] p-6 rounded-lg" id="faq-4">
                <div class="flex justify-between items-center">
                    <h3 class="text-xl font-semibold text-[#F58A44]" style="font-family: 'Inter', sans-serif;">Bolehkah membagikan akun ke orang lain?
                    </h3>
                    <button class="text-[#F58A44]" onclick="toggleAnswer(4)">
                        <span id="toggle-icon-4">+</span>
                    </button>
                </div>
                <p id="answer-4" class="text-[#484848] hidden mt-4" style="font-family: 'Inter', sans-serif;">Mohon maaf tidak diperbolehkan, hanya yang terdaftar yang boleh mengakses.
        ...
        <div class="container mx-auto">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                ...
                <div class=" sm:text-left mb-6 sm:mb-0 max-w-xs sm:max-w-sm">
                    ...
                    <p class="font-semibold text-lg pt-4" style="font-family: 'Inter', sans-serif;">Hidup Tentram sesuai Panduan Islam</p>

                    <div class="border border-white rounded-lg p-1 inline-flex items-center"><p class="text-sm mt-2" style="font-family: 'Inter', sans-serif; display: inline;">Bagian Dari: </p><img src="{{ asset('img/academy.png') }}" alt="Hero Image" style="width: 80px; display: inline;"></div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row justify-between gap-8 w-full sm:w-auto">
                    ...
                    <div class="sm:w-1/2">
                        ...
                        <ul class="space-y-4 -ml-8 text-sm text-white">
                            <li><a href="#hero" class="text-white hover:text-[#FDE4D3]" style="font-family: 'Inter', sans-serif;">Introduction</a></li>
                            <li><a href="#Kenapa harus" class="text-white hover:text-[#FDE4D3]" style="font-family: 'Inter', sans-serif;">Why ShaeLife</a></li>
                            <li><a href="#testimoni" class="text-white hover:text-[#FDE4D3]" style="font-family: 'Inter', sans-serif;">Testimonial</a></li>
                            <li><a href="#FAQ" class="text-white hover:text-[#FDE4D3]" style="font-family: 'Inter', sans-serif;">FAQ</a></li>
                        </ul>
                    </div>

                    <!-- Explore Section -->
                    <div class="sm:w-1/2">
                        <h6 class="ml-8 font-semibold text-white mb-3 " style="font-family: 'Inter', sans-serif;">Explore</h6>
                        <ul class="space-y-4 text-sm text-white">
                            <li><a href="#Kurikulum" class="text-white hover:text-[#FDE4D3]" style="font-family: 'Inter', sans-serif;">Kurikulum</a></li>
                            <li><a href="#mentor" class="text-white hover:text-[#FDE4D3]" style="font-family: 'Inter', sans-serif;">Mentor</a></li>
                            <li><a href="#subscription" class=" text-white hover:text-[#FDE4D3]" style="font-family: 'Inter', sans-serif;">Subscription</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <ul class="-ml-8 flex space-x-6 justify-center sm:justify-start">
                        <li>
                            <a href="https://facebook.com" target="_blank" class="hover:text-[#FDE4D3]">
                                <svg class="w-6 h-6 text-white hover:text-[#FDE4D3] transition duration-300 ease-in-out" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M22.675 0H1.325C.593 0 0 .593 0 1.325v21.351C0 23.406.593 24 1.325 24h11.497v-9.294H9.847v-3.622h2.975V8.413c0-2.946 1.796-4.548 4.417-4.548 1.254 0 2.332.093 2.646.134v3.068h-1.816c-1.426 0-1.7.678-1.7 1.67v2.186h3.403l-.444 3.622h-2.959V24h5.788c.73 0 1.324-.594 1.324-1.325V1.325C24 .593 23.406 0 22.675 0z"/>
                                </svg>
                            </a>
                        </li>
                        <li>
